...
export default function ClaimReviews() {
  ...
  if (loading) {
    return <div className="p-6 flex items-center justify-center min-h-[300px]"><RefreshCw className="animate-spin text-asap-blue" size={32} /></div>;
  }
    ...
    <div className="p-6 lg:p-8 max-w-5xl mx-auto space-y-8">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-slate-500">See unassigned reviews and claim the ones you earned. A manager approves your claim and it counts toward your reviews.</p>
        </div>
        <button onClick={loadData} className="flex items-center gap-2 px-4 py-2.5 border border-slate-200 rounded-xl hover:bg-slate-50">
