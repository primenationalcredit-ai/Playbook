// payment-enrich-manual.js - keyed on-demand TWIN of payment-enrich.js (schedule is Mon-Sat 8-23; Sundays and testing need a door).
...
exports.handler = async (event) => {
  // MANUAL DOOR (8/30, twin of payment-enrich - Netlify blocks direct HTTP on scheduled fns; repo is ESM so a require() wrapper 502s. Same twin pattern as zoho-payment-sync-manual. TWIN DRIFT WARNING: patches to payment-enrich must be applied here too.)
