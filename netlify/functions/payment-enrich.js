...
exports.handler = async (event) => {
  ...
  try {
    ...
    const res = await fetch(
      `${SUPABASE_URL}/rest/v1/consultant_payments?consultant_name=in.(Unknown,pending_enrichment)&pipedrive_deal_id=not.is.null&select=id,pipedrive_deal_id,client_name,payment_type&order=payment_date.desc&limit=30`,
