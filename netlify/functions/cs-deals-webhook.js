...
exports.handler = async (event) => {
  ...
  try {
    ...
    const row = {
      ...
      call_center_rep_id: callCenterRepId != null ? callCenterRepId : ((existing && existing.call_center_rep_id) || null),
      call_center_rep_name: callCenterRepName || (existing && existing.call_center_rep_name) || null,
      account_manager_id: accountManagerId != null ? accountManagerId : ((existing && existing.account_manager_id) || null),
      account_manager_name: accountManagerName || (existing && existing.account_manager_name) || null,
