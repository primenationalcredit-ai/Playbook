import sys
# ---- 1) the background describer ----
fn = """// netlify/functions/media-describe-background.js
//
...
"""
open('netlify/functions/media-describe-background.js', 'w', encoding='utf-8', newline='').write(fn)
print("media-describe-background.js written")
# ---- 2) fire it after Add Video saves ----
f = 'src/pages/MediaLibrary.jsx'
s = open(f, encoding='utf-8', errors='surrogateescape').read()
a = "setShowAdd(false); setFile(null);"
if s.count(a) != 1: print("ABORTED: save anchor x" + str(s.count(a))); sys.exit(1)
s = s.replace(a, a + "\n      fetch('/.netlify/functions/media-describe-background', { method: 'POST' }).catch(() => {}); // AI summary, fire-and-forget", 1)
open(f, 'w', encoding='utf-8', errors='surrogateescape', newline='').write(s)
print("MediaLibrary.jsx fires describer after save")
